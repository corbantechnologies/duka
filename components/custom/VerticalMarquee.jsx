...
const ReviewCard = ({
  ...
  return (
    <figure
      className={cn(
        "relative w-48 cursor-pointer overflow-hidden rounded-xl ",
...
export function VerticalMarquee() {
  return (
    <div className="relative flex h-fit md:h-screen w-full items-center justify-center overflow-hidden">
      ...
      <Marquee pauseOnHover vertical className="hidden md:flex [--duration:40s]">
        {thirdRow.map((review) => (
          <ReviewCard key={review.username} {...review} />
        ))}
      </Marquee>
